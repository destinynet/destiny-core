...
enum class EventType(
  ...
  RECOVERY_FROM_ILLNESS(HEALTH_AND_ACCIDENTS, true),  // 從重大疾病/意外中康復

  // 名聲與人際
  RISE_TO_FAME(REPUTATION_AND_RELATIONSHIPS, true),           // 聲名大噪
  BACKLASH(REPUTATION_AND_RELATIONSHIPS, true),               // 強烈反對
  FALL_FROM_GRACE(REPUTATION_AND_RELATIONSHIPS, true),        // 失勢
  GOING_VIRAL(REPUTATION_AND_RELATIONSHIPS, true),            // 爆紅
  PUBLIC_SCANDAL(REPUTATION_AND_RELATIONSHIPS, true),         // 醜聞爆發
  LAWSUIT_LITIGATION(REPUTATION_AND_RELATIONSHIPS, true),     // 官司
  IMPEACHMENT(REPUTATION_AND_RELATIONSHIPS, true),            // 彈劾
  ARRESTED(REPUTATION_AND_RELATIONSHIPS, true),               // 被捕
  IMPRISONMENT(REPUTATION_AND_RELATIONSHIPS, true),           // 入獄服刑
  LIBERATION_OR_RELEASE(REPUTATION_AND_RELATIONSHIPS, true),  // 重獲自由／釋放
  CONTEST_DEFEAT(REPUTATION_AND_RELATIONSHIPS, true),         // 競逐失利 (如選舉、商業奪權)
