...
interface IStarPosition<out T : IStarPos> {
  ...
  fun getPosition(star: Star, gmtJulDay: GmtJulDay, centric: Centric, coordinate: Coordinate, options: StarTypeOptions): T
   ...
   * ```
   */
  fun calculate(star: Star, gmtJulDay: GmtJulDay, centric: Centric, coordinate: Coordinate, options: StarTypeOptions = StarTypeOptions.MEAN): T
   ...
   */
  fun calculateAll(stars: Iterable<Star>, gmtJulDay: GmtJulDay, centric: Centric, coordinate: Coordinate, options: StarTypeOptions = StarTypeOptions.MEAN): Map<Star, T>
  ...
  fun calculateWithAzimuth(star: Star,
                           ...
                           options: StarTypeOptions = StarTypeOptions.MEAN): T {
