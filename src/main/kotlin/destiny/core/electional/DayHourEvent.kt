...
sealed class DayHourEvent {
  ...
  sealed class EwEvent : DayHourEvent() {
    ...
    sealed class EwPersonalEvent : EwEvent() {
      ...
      data class StemAffecting(override val gmtJulDay: GmtJulDay, override val pattern: FlowPattern.Affecting, override val outer: IEightWords) : EwPersonalEvent() {
      ...
      data class StemCombined(override val gmtJulDay: GmtJulDay, override val pattern: FlowPattern.StemCombined, override val outer: IEightWords) : EwPersonalEvent() {
      ...
      data class BranchCombined(override val gmtJulDay: GmtJulDay, override val pattern: FlowPattern.BranchCombined, override val outer: IEightWords) : EwPersonalEvent() {
        override val type: Type = Type.GOOD
        override val hourRelated: Boolean = pattern.scale == Scale.HOUR
        override val outerScale: Scale
          get() = when (pattern.flowScale) {
      ...
      data class TrilogyToFlow(override val gmtJulDay: GmtJulDay, override val pattern: FlowPattern.TrilogyToFlow, override val outer: IEightWords) : EwPersonalEvent() {
        override val type: Type = Type.GOOD
      ...
      data class ToFlowTrilogy(override val gmtJulDay: GmtJulDay, override val pattern: FlowPattern.ToFlowTrilogy, override val outer: IEightWords) : EwPersonalEvent() {
        override val type: Type = Type.GOOD
        override val hourRelated: Boolean = pattern.scale == Scale.HOUR
        override val outerScale: Scale
          get() {
      ...
      data class BranchOpposition(override val gmtJulDay: GmtJulDay, override val pattern: FlowPattern.BranchOpposition, override val outer: IEightWords) : EwPersonalEvent() {
