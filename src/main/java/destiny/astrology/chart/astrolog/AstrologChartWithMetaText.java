...
public class AstrologChartWithMetaText extends AstrologChart {
  ...
  public AstrologChartWithMetaText(HoroscopeContext context, int width) {
    super(context.getHoroscope(), width);
    ...
    g.drawString(lmt, fontSize, getHeight() - fontSize * 3);
    ...
    g.drawString(gmt, fontSize, getHeight() - fontSize * 2);
    ...
    g.drawString(locString , fontSize , getHeight() - fontSize );
