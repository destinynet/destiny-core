  ...
  protected Optional<Pair<String, Object[]>> getResult(Planet planet, @NotNull HoroscopeContext horoscopeContext)
  {
    ...
    if (t.v1()) {
      ...
      if (t.v4().isPresent()) {
        ...
        return Optional.of(ImmutablePair.of("commentAspect", new Object[]{planet, t.v2(), t.v3(), deg, t.v4().get()}));
      }
      else {
        //sb.append("(未形成交角)");
        return Optional.of(ImmutablePair.of("commentUnaspect" , new Object[]{planet , t.v2() , t.v3() , deg }));
      }
