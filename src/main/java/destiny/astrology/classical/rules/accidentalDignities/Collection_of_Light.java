...
public final class Collection_of_Light extends Rule
{
  ...
  protected Optional<Tuple2<String, Object[]>> getResult(Planet planet, @NotNull Horoscope h)
  {
    ...
    Tuple2<Boolean, List<Planet>> t = collectionOfLightImpl.getResult(planet , h, CollectionOfLightIF.CollectType.DIGNITIES);
    if (t.v1())
    {
      ...
      return Optional.of(Tuple.tuple("comment", new Object[]{planet, twoPlanets.get(0), twoPlanets.get(1), h.getAngle(twoPlanets.get(0), twoPlanets.get(1))}));
    }
