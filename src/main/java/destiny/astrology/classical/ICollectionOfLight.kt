...
interface ICollectionOfLight {
   ...
   */
  fun getResult(planet: Planet, h: Horoscope, collectType: CollectType): List<Planet>?
   ...
   */
  fun getResultMaybeType(planet: Planet, h: Horoscope, collectType: CollectType?): Pair<List<Planet>, CollectType>?
