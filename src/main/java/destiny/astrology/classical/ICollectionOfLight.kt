...
interface ICollectionOfLight {
   ...
   */
  fun getResult(planet: Planet, h: IHoro, collectType: CollectType): List<Planet>?
   ...
   */
  fun getResultMaybeType(planet: Planet, h: IHoro, collectType: CollectType?): Pair<List<Planet>, CollectType>?
