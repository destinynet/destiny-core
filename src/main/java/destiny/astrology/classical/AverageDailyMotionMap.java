...
public class AverageDailyMotionMap
{
  ...
  private final static ImmutableMap<Planet,Double> averageDailyMotionMap = new ImmutableMap.Builder<Planet , Double>()
    .put(Planet.SUN     ,  0.0 + 59.0/60 + 8.0/3600)
    .put(Planet.MOON    , 13.0 + 10.0/60 + 36.0/3600)
    .put(Planet.MERCURY ,  1.0 + 23.0/60)
    .put(Planet.VENUS   ,  1.0 + 12.0/60)
    .put(Planet.MARS    ,  0.0 + 31.0/60 + 27.0/3600)
    .put(Planet.JUPITER ,  0.0 +  5.0/60)
    .put(Planet.SATURN  ,  0.0 +  2.0/60 + 1.0/3600)
    .build();
