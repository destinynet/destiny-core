...
private val table: Set<Triple<ZStar, Branch, Int>> = setOf(
  ...
  , Triple(巨門, 子, 2), Triple(巨門, 丑, 6), Triple(巨門, 寅, 1), Triple(巨門, 卯, 1), Triple(巨門, 辰, 2), Triple(巨門, 巳, 2), Triple(巨門, 午, 2), Triple(巨門, 未, 6), Triple(巨門, 申, 1), Triple(巨門, 酉, 1), Triple(巨門, 戌, 7), Triple(巨門, 亥, 2)
