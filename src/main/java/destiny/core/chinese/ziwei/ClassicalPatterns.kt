...
sealed class ClassicalPattern(
  ...
  data class 紫府朝垣(val house: House, val goods: Set<GoodCombo>) : ClassicalPattern(GOOD, "[" + house.toString() + "宮]" + goods.joinToString(","))
  data class 天府朝垣(val goods: Set<GoodCombo>) : ClassicalPattern(GOOD, goods.joinToString(","))
  data class 府相朝垣(val house: House, val goods: Set<GoodCombo>) : ClassicalPattern(GOOD, "[" + house.toString() + "宮]" + goods.joinToString(","))
  ...
  data class 君臣慶會(val house: House, val goods: Set<GoodCombo>) : ClassicalPattern(GOOD, "[" + house.toString() + "宮]" + goods.joinToString(","))
  ...
  data class 權祿巡逢(val house: House, val goods: Set<GoodCombo>) : ClassicalPattern(GOOD, "[" + house.toString() + "宮]" + goods.joinToString(","))

  object 科權祿夾 : ClassicalPattern(GOOD)
  object 文星拱命 : ClassicalPattern(GOOD)
  data class 財祿夾馬(val house: House, val goods: Set<GoodCombo>) : ClassicalPattern(GOOD, "[" + house.toString() + "宮]" + goods.joinToString(","))
