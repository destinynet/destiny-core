...
sealed class ClassicalPattern(override val name: String,
  ...
  object 極向離明 : ClassicalPattern(極向離明::class.java.simpleName, PatternType.GOOD)
  object 紫府同宮 : ClassicalPattern(紫府同宮::class.java.simpleName, PatternType.GOOD)
  class 紫府朝垣(house: House, goods: Set<GoodCombo>) :
    ClassicalPattern(紫府朝垣::class.java.simpleName, PatternType.GOOD, "[" + house.toString() + "]" + goods.joinToString(","))

  class 天府朝垣(goods: Set<GoodCombo>) : ClassicalPattern(天府朝垣::class.java.simpleName, PatternType.GOOD, goods.joinToString(","))
  class 府相朝垣(house: House, goods: Set<GoodCombo>) :
    ClassicalPattern(府相朝垣::class.java.simpleName, PatternType.GOOD, "[" + house.toString() + "]" + goods.joinToString(","))

  class 巨機同宮(branch: Branch, goods: Set<GoodCombo>) :
    ClassicalPattern(巨機同宮::class.java.simpleName, PatternType.GOOD, "[" + branch.toString() + "]" + goods.joinToString(","))

  class 善蔭朝綱(goods: Set<GoodCombo>) : ClassicalPattern(善蔭朝綱::class.java.simpleName, PatternType.GOOD, goods.joinToString(","))
  object 機月同梁 : ClassicalPattern(機月同梁::class.java.simpleName, PatternType.GOOD)
  class 日月照壁(goods: Set<GoodCombo>) : ClassicalPattern(日月照壁::class.java.simpleName, PatternType.GOOD, goods.joinToString(","))
  class 日麗中天(dayNight: DayNight, goods: Set<GoodCombo>) :
    ClassicalPattern(日麗中天::class.java.simpleName, PatternType.GOOD, "[" + dayNight.toString() + "]" + goods.joinToString(","))


  class 君臣慶會(house: House, goods: Set<GoodCombo>) :
    ClassicalPattern(君臣慶會::class.java.simpleName, PatternType.GOOD, "[" + house.toString() + "]" + goods.joinToString(","))

  object 日月同宮 : ClassicalPattern(日月同宮::class.java.simpleName, PatternType.GOOD)
  object 日月並明 : ClassicalPattern(日月並明::class.java.simpleName, PatternType.GOOD)
  object 日照雷門 : ClassicalPattern(日照雷門::class.java.simpleName, PatternType.GOOD)
  class 陽梁昌祿(house: House) : ClassicalPattern(陽梁昌祿::class.java.simpleName, PatternType.GOOD, "[$house]")
  object 明珠出海 : ClassicalPattern(明珠出海::class.java.simpleName, PatternType.GOOD)
  object 巨日同宮 : ClassicalPattern(巨日同宮::class.java.simpleName, PatternType.GOOD)
  object 貪武同行 : ClassicalPattern(貪武同行::class.java.simpleName, PatternType.GOOD)
  object 將星得地 : ClassicalPattern(將星得地::class.java.simpleName, PatternType.GOOD)
  class 七殺朝斗(goods: Set<GoodCombo>) : ClassicalPattern(七殺朝斗::class.java.simpleName, PatternType.GOOD, goods.joinToString(","))
  object 雄宿朝垣 : ClassicalPattern(雄宿朝垣::class.java.simpleName, PatternType.GOOD)
  object 對面朝天 : ClassicalPattern(對面朝天::class.java.simpleName, PatternType.GOOD)
  object 科名會祿 : ClassicalPattern(科名會祿::class.java.simpleName, PatternType.GOOD)
  object 甲第登科 : ClassicalPattern(甲第登科::class.java.simpleName, PatternType.GOOD)
  object 科權逢迎 : ClassicalPattern(科權逢迎::class.java.simpleName, PatternType.GOOD)
  object 祿合鴛鴦 : ClassicalPattern(祿合鴛鴦::class.java.simpleName, PatternType.GOOD)
  class 雙祿朝垣(house: House) : ClassicalPattern(雙祿朝垣::class.java.simpleName, PatternType.GOOD, "[$house]")
  object 三奇嘉會 : ClassicalPattern(三奇嘉會::class.java.simpleName, PatternType.GOOD)
  object 祿馬交馳 : ClassicalPattern(祿馬交馳::class.java.simpleName, PatternType.GOOD)
  class 月朗天門(dayNight: DayNight) : ClassicalPattern(月朗天門::class.java.simpleName, PatternType.GOOD, dayNight.toString())
  class 月生滄海(dayNight: DayNight) : ClassicalPattern(月生滄海::class.java.simpleName, PatternType.GOOD, dayNight.toString())
  class 石中隱玉(goods: Set<GoodCombo>) : ClassicalPattern(石中隱玉::class.java.simpleName, PatternType.GOOD, goods.joinToString(","))
  class 壽星入廟(goods: Set<GoodCombo>) : ClassicalPattern(壽星入廟::class.java.simpleName, PatternType.GOOD, goods.joinToString(","))
  class 英星入廟(goods: Set<GoodCombo>) : ClassicalPattern(英星入廟::class.java.simpleName, PatternType.GOOD, goods.joinToString(","))
  //class 機梁加會(goods: Set<GoodCombo>) : Pattern(機梁加會::class.java.simpleName, GOOD, goods.joinToString(","))
  class 文桂文華(route: Route) : ClassicalPattern(文桂文華::class.java.simpleName, PatternType.GOOD, route.toString())

  class 文梁振紀(goods: Set<GoodCombo>) : ClassicalPattern(文梁振紀::class.java.simpleName, PatternType.GOOD, goods.joinToString(","))
  class 魁鉞拱命(route: Route) : ClassicalPattern(魁鉞拱命::class.java.simpleName, PatternType.GOOD, route.toString())
  class 左右同宮(goods: Set<GoodCombo>) : ClassicalPattern(左右同宮::class.java.simpleName, PatternType.GOOD, goods.joinToString(","))
  object 丹墀桂墀 : ClassicalPattern(丹墀桂墀::class.java.simpleName, PatternType.GOOD)
  object 甲第登庸 : ClassicalPattern(甲第登庸::class.java.simpleName, PatternType.GOOD)
  object 化星返貴 : ClassicalPattern(化星返貴::class.java.simpleName, PatternType.GOOD)
  object 天乙拱命 : ClassicalPattern(天乙拱命::class.java.simpleName, PatternType.GOOD)
  object 坐貴向貴 : ClassicalPattern(坐貴向貴::class.java.simpleName, PatternType.GOOD)
  object 廉貞文武 : ClassicalPattern(廉貞文武::class.java.simpleName, PatternType.GOOD)
  class 星臨正位(stars: Set<ZStar>) : ClassicalPattern(星臨正位::class.java.simpleName, PatternType.GOOD, stars.joinToString(","))
  class 輔拱文星(house: House) : ClassicalPattern(輔拱文星::class.java.simpleName, PatternType.GOOD, "[$house]")
  class 三合火貪(house: House) : ClassicalPattern(三合火貪::class.java.simpleName, PatternType.GOOD, "[$house]")
  class 三合鈴貪(house: House) : ClassicalPattern(三合鈴貪::class.java.simpleName, PatternType.GOOD, "[$house]")
  class 權祿巡逢(house: House, goods: Set<GoodCombo>) :
    ClassicalPattern(權祿巡逢::class.java.simpleName, PatternType.GOOD, "[" + house.toString() + "]" + goods.joinToString(","))

  object 科權祿夾 : ClassicalPattern(科權祿夾::class.java.simpleName, PatternType.GOOD)
  object 文星拱命 : ClassicalPattern(文星拱命::class.java.simpleName, PatternType.GOOD)
  class 財祿夾馬(house: House, goods: Set<GoodCombo>) :
    ClassicalPattern(財祿夾馬::class.java.simpleName, PatternType.GOOD, "[" + house.toString() + "]" + goods.joinToString(","))

  class 財蔭夾印(house: House) : ClassicalPattern(財蔭夾印::class.java.simpleName, PatternType.GOOD, "[$house]")
  class 擎羊入廟(house: House) : ClassicalPattern(擎羊入廟::class.java.simpleName, PatternType.GOOD, "[$house]")
  class 祿馬配印(house: House) : ClassicalPattern(祿馬配印::class.java.simpleName, PatternType.GOOD, "[$house]")
  object 紫府夾命 : ClassicalPattern(紫府夾命::class.java.simpleName, PatternType.GOOD)
  object 日月夾命 : ClassicalPattern(日月夾命::class.java.simpleName, PatternType.GOOD)
  object 昌曲夾命 : ClassicalPattern(昌曲夾命::class.java.simpleName, PatternType.GOOD)
  object 左右夾命 : ClassicalPattern(左右夾命::class.java.simpleName, PatternType.GOOD)
  object 雙祿夾命 : ClassicalPattern(雙祿夾命::class.java.simpleName, PatternType.GOOD)
  object 權煞化祿 : ClassicalPattern(權煞化祿::class.java.simpleName, PatternType.GOOD)
  object 祿文拱命 : ClassicalPattern(祿文拱命::class.java.simpleName, PatternType.GOOD)
  object 明祿暗祿 : ClassicalPattern(明祿暗祿::class.java.simpleName, PatternType.GOOD)
  object 水木清華 : ClassicalPattern(水木清華::class.java.simpleName, PatternType.GOOD)
  class 金鑾扶駕(house: House) : ClassicalPattern(金鑾扶駕::class.java.simpleName, PatternType.GOOD, "[$house]")
  object 玉袖添香 : ClassicalPattern(玉袖添香::class.java.simpleName, PatternType.GOOD)
  object 殺破狼格 : ClassicalPattern(殺破狼格::class.java.simpleName, PatternType.GOOD)
  object 廟星變景 : ClassicalPattern(廟星變景::class.java.simpleName, PatternType.GOOD)
  object 辛勞開創 : ClassicalPattern(辛勞開創::class.java.simpleName, PatternType.GOOD)
  object 財印天祿 : ClassicalPattern(財印天祿::class.java.simpleName, PatternType.GOOD)
  object 蟾宮折桂 : ClassicalPattern(蟾宮折桂::class.java.simpleName, PatternType.GOOD)

  // =========================== 以下 , 惡格 ===========================

  class 馬頭帶劍(evils: Set<EvilCombo>) : ClassicalPattern(馬頭帶劍::class.java.simpleName, PatternType.EVIL, evils.joinToString(","))
  class 極居卯酉(evils: Set<EvilCombo>) : ClassicalPattern(極居卯酉::class.java.simpleName, PatternType.EVIL, evils.joinToString(","))
  object 命無正曜 : ClassicalPattern(命無正曜::class.java.simpleName, PatternType.EVIL)
  object 風流綵杖 : ClassicalPattern(風流綵杖::class.java.simpleName, PatternType.EVIL)
  object 巨機化酉 : ClassicalPattern(巨機化酉::class.java.simpleName, PatternType.EVIL)
  object 日月反背 : ClassicalPattern(日月反背::class.java.simpleName, PatternType.EVIL)
  object 日月疾厄 : ClassicalPattern(日月疾厄::class.java.simpleName, PatternType.EVIL)
  object 梁馬飄蕩 : ClassicalPattern(梁馬飄蕩::class.java.simpleName, PatternType.EVIL)
  object 貞殺同宮 : ClassicalPattern(貞殺同宮::class.java.simpleName, PatternType.EVIL)
  object 殺拱廉貞 : ClassicalPattern(殺拱廉貞::class.java.simpleName, PatternType.EVIL)
  class 巨逢四煞(house: House) : ClassicalPattern(巨逢四煞::class.java.simpleName, PatternType.EVIL, "[$house]")
  object 命裡逢空 : ClassicalPattern(命裡逢空::class.java.simpleName, PatternType.EVIL)
  class 文星遇夾(evils: Set<EvilCombo>) : ClassicalPattern(文星遇夾::class.java.simpleName, PatternType.EVIL, evils.joinToString(","))
  object 馬落空亡 : ClassicalPattern(馬落空亡::class.java.simpleName, PatternType.EVIL)
  object 兩重華蓋 : ClassicalPattern(兩重華蓋::class.java.simpleName, PatternType.EVIL)
  object 祿逢衝破 : ClassicalPattern(祿逢衝破::class.java.simpleName, PatternType.EVIL)
  object 泛水桃花 : ClassicalPattern(泛水桃花::class.java.simpleName, PatternType.EVIL)
  object 天梁拱月 : ClassicalPattern(天梁拱月::class.java.simpleName, PatternType.EVIL)
  object 財與囚仇 : ClassicalPattern(財與囚仇::class.java.simpleName, PatternType.EVIL)
  object 火入泉鄉 : ClassicalPattern(火入泉鄉::class.java.simpleName, PatternType.EVIL)
  object 祿逢兩煞 : ClassicalPattern(祿逢兩煞::class.java.simpleName, PatternType.EVIL)
  class 君子在野(evils: Set<EvilCombo>) : ClassicalPattern(君子在野::class.java.simpleName, PatternType.EVIL, evils.joinToString(","))
  class 羊陀夾忌(house: House) : ClassicalPattern(羊陀夾忌::class.java.simpleName, PatternType.EVIL, house.toString())
  class 火鈴夾忌(house: House) : ClassicalPattern(火鈴夾忌::class.java.simpleName, PatternType.EVIL, house.toString())
  object 羊陀夾命 : ClassicalPattern(羊陀夾命::class.java.simpleName, PatternType.EVIL)
  object 火鈴夾命 : ClassicalPattern(火鈴夾命::class.java.simpleName, PatternType.EVIL)
  object 空劫夾命 : ClassicalPattern(空劫夾命::class.java.simpleName, PatternType.EVIL)
  class 刑囚夾印(house: House) : ClassicalPattern(刑囚夾印::class.java.simpleName, PatternType.EVIL, "[$house]")
  class 刑忌夾印(house: House) : ClassicalPattern(刑忌夾印::class.java.simpleName, PatternType.EVIL, "[$house]")
  class 祿衰馬困(house: House) : ClassicalPattern(祿衰馬困::class.java.simpleName, PatternType.EVIL, "[$house]")
  object 名不利達 : ClassicalPattern(名不利達::class.java.simpleName, PatternType.EVIL)
  object 三方並凶 : ClassicalPattern(三方並凶::class.java.simpleName, PatternType.EVIL)
  class 三奇沖剋(house: House) : ClassicalPattern(三奇沖剋::class.java.simpleName, PatternType.EVIL, "[$house]")
  object 天機巳亥 : ClassicalPattern(天機巳亥::class.java.simpleName, PatternType.EVIL)
  object 月同遇煞 : ClassicalPattern(月同遇煞::class.java.simpleName, PatternType.EVIL)
  object 桃花滾浪 : ClassicalPattern(桃花滾浪::class.java.simpleName, PatternType.EVIL)
  object 梁同巳亥 : ClassicalPattern(梁同巳亥::class.java.simpleName, PatternType.EVIL)
  class 科星逢破(house: House) : ClassicalPattern(科星逢破::class.java.simpleName, PatternType.EVIL, "[$house]")
  class 刑囚會鈴(house: House) : ClassicalPattern(刑囚會鈴::class.java.simpleName, PatternType.EVIL, "[$house]")
  object 鈴昌陀武 : ClassicalPattern(鈴昌陀武::class.java.simpleName, PatternType.EVIL)
  object 廉殺羊鈴 : ClassicalPattern(廉殺羊鈴::class.java.simpleName, PatternType.EVIL)
  object 一生孤貧 : ClassicalPattern(一生孤貧::class.java.simpleName, PatternType.EVIL)
  class 魁鉞凶冲(evils: Set<EvilCombo>) : ClassicalPattern(魁鉞凶冲::class.java.simpleName, PatternType.EVIL, evils.joinToString(","))
  object 眾水朝東 : ClassicalPattern(眾水朝東::class.java.simpleName, PatternType.EVIL)
  // TODO : 在野孤君 , 無道之君
