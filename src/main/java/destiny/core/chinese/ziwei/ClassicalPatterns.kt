...
sealed class ClassicalPattern(override val name: String,
  ...
  class 陽梁昌祿(house: House) : ClassicalPattern("陽梁昌祿", PatternType.GOOD, "[$house]")
  ...
  class 雙祿朝垣(house: House) : ClassicalPattern("雙祿朝垣", PatternType.GOOD, "[$house]")
  ...
  class 輔拱文星(house: House) : ClassicalPattern("輔拱文星", PatternType.GOOD, "[$house]")
  class 三合火貪(house: House) : ClassicalPattern("三合火貪", PatternType.GOOD, "[$house]")
  class 三合鈴貪(house: House) : ClassicalPattern("三合鈴貪", PatternType.GOOD, "[$house]")
  ...
  class 財蔭夾印(house: House) : ClassicalPattern("財蔭夾印", PatternType.GOOD, "[$house]")
  class 擎羊入廟(house: House) : ClassicalPattern("擎羊入廟", PatternType.GOOD, "[$house]")
  class 祿馬配印(house: House) : ClassicalPattern("祿馬配印", PatternType.GOOD, "[$house]")
  ...
  class 金鑾扶駕(house: House) : ClassicalPattern("金鑾扶駕", PatternType.GOOD, "[$house]")
  ...
  class 巨逢四煞(house: House) : ClassicalPattern("巨逢四煞", PatternType.EVIL, "[$house]")
  ...
  class 刑囚夾印(house: House) : ClassicalPattern("刑囚夾印", PatternType.EVIL, "[$house]")
  class 刑忌夾印(house: House) : ClassicalPattern("刑忌夾印", PatternType.EVIL, "[$house]")
  class 祿衰馬困(house: House) : ClassicalPattern("祿衰馬困", PatternType.EVIL, "[$house]")
  object 名不利達 : ClassicalPattern("名不利達", PatternType.EVIL)
  object 三方並凶 : ClassicalPattern("三方並凶", PatternType.EVIL)
  class 三奇沖剋(house: House) : ClassicalPattern("三奇沖剋", PatternType.EVIL, "[$house]")
  ...
  class 科星逢破(house: House) : ClassicalPattern("科星逢破", PatternType.EVIL, "[$house]")
  class 刑囚會鈴(house: House) : ClassicalPattern("刑囚會鈴", PatternType.EVIL, "[$house]")
