...
interface IHoloPoemContext : IHoloContext {
  ...
  fun getHoloWithTimeFull(lmt: ChronoLocalDateTime<*>, loc: ILocation, gender: Gender, gmt: Double, name: String? = null, place: String? = null): Pair<IPoemHolo, List<HoloFullHexagram>>
}
