...
public interface MonthMasterIF extends Descriptive {
   ...
   * */
  static String getName(Branch branch) {
    switch (branch) {
      ...
      case 寅 : return "功曹"; // 功曹者，古之太史。宋國人，姓孟，字仲賢，欺客印死於十月寅日，除為功曹。知人官事、口舌、文字、信息。天乙加臨，主印信之喜。騰蛇主驚憂，後喜生女也，朱雀遠信、火光，六合婚姻不成，勾陳婦女爭訟，青龍本位大吉，天后婦女婚姻，太陰同天後，玄武財喜不失，太常陰財破，白虎入家凶，天空鬥訟虛詐。
