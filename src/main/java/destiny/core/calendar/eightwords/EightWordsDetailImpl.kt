...
class EightWordsDetailImpl : IEightWordsDetail, Serializable {
  ...
  override fun getDetails(lmt: ChronoLocalDateTime<*>, location: Location, place: String, eightWordsImpl: EightWordsIF, yearMonthImpl: YearMonthIF, chineseDateImpl: ChineseDateIF, dayImpl: DayIF, hourImpl: HourIF, midnightImpl: MidnightIF, changeDayAfterZi: Boolean, risingSignImpl: IRisingSign, starPositionImpl: IStarPosition<*>, solarTermsImpl: SolarTermsIF): EightWordsContextModel {
