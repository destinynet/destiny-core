...
/**
 * https://github.com/ThreeTen/threeten-extra/blob/master/src/main/java/org/threeten/extra/chrono/AbstractDate.java
 *
...
abstract class AbstractDate implements ChronoLocalDate {
  ...
  @Override  // override for performance
  public int hashCode() {
    return getChronology().getId().hashCode() ^ ((getProlepticYear() & 0xFFFFF800) ^ ((getProlepticYear() << 11) + (getMonth() << 6) + (getDayOfMonth())));
  }

  @Override
  public String toString() {
    StringBuilder buf = new StringBuilder(30);
    buf.append(getChronology().toString()).append(" ").append(getEra()).append(" ").append(getYearOfEra()).append(getMonth() < 10 ? "-0" : "-").append(getMonth()).append(getDayOfMonth() < 10 ? "-0" : "-").append(getDayOfMonth());
    return buf.toString();
  }
