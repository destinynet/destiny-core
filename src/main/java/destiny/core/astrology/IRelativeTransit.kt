...
interface IRelativeTransit {
   ...
   */
  fun getNearestRelativeTransitGmtJulDay(transitStar: Star , relativeStars: Collection<Star> , fromGmtJulDay: Double , aspects : Collection<Aspect> , forward: Boolean): IAspectData? {
