...
public class JulDay1582CutoverImplTest {
  ...
  public void julDay2DateTime() throws Exception {
    ...
    // Gregorian 第一天 : 1582-10-15 , julDay = 2299160.5
    Tuple2<ChronoLocalDate , LocalTime> dateTime1 = JulDay1582CutoverImpl.fromGmtJulDay(firstDayOfGregorian);
    ...
    Tuple2<ChronoLocalDate , LocalTime> dateTime2 = JulDay1582CutoverImpl.fromGmtJulDay(firstDayOfGregorian-1);
