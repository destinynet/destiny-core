...
public class TimeToolsTest {
  ...
  public void test_getJulDayFromGregorian() {
    assertEquals(2457774, getGmtJulDay(LocalDateTime.of(2017, 1, 20, 12, 0, 0)), 0.0);
    assertEquals(2457774, getGmtJulDay(JulianDateTime.of(2017, 1, 7, 12, 0, 0)), 0.0);
  }
  ...
  public void testJulDayZero() {
    double startJulG = getGmtJulDay(LocalDateTime.of(-4713, 11, 24, 12, 0));
    assertEquals(0, startJulG, 0.0);

    double startJulJ = getGmtJulDay(JulianDateTime.of(-4712, 1, 1, 12, 0));
  ...
  public void testJulianDateTime() {
    // 中午 , 0
    assertEquals(2457774, getGmtJulDay(JulianDateTime.of(2017, 1, 7, 12, 0)), 0.0);
  ...
  public void testGetLmtFromGmt() {
    ...
    ChronoLocalDateTime lmt2 = getLmtFromGmt(gmt, loc);
