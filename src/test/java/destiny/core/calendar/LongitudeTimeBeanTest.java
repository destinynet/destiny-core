...
public class LongitudeTimeBeanTest
{
  ...
  Location location ;
  Time expected;
  LongitudeTimeBean bean ;
  
  /** 東經121度30分 , 應該加六分鐘 */
  @Test
  public void testGetLocalTimeEast1()
  {
    lmt = new Time(2007,3,14,0,0,0);
    location = new Location(EastWest.EAST , 121,30,0,NorthSouth.NORTH , 25 , 03 , 0 , 0 , TimeZone.getTimeZone("Asia/Taipei")) ;
    
    bean = new LongitudeTimeBean(lmt , location);
    expected = new Time(2007,3,14,0,6,0);
    assertEquals(expected , bean.getLocalTime());
  }
  ...
  public void testGetLocalTimeEast2()
  {
    ...
    bean = new LongitudeTimeBean(lmt , location);
    expected = new Time(2007,3,14,0,40,0);
    assertEquals(expected , bean.getLocalTime());
  }
  ...
  public void testGetLocalTimeEast3()
  {
    ...
    bean = new LongitudeTimeBean(lmt , location);
    expected = new Time(2007,3,13,23,42,0);
    assertEquals(expected , bean.getLocalTime());
  }
  ...
  public void testGetLocalTimeEast4()
  {
    ...
    bean = new LongitudeTimeBean(lmt , location);
    expected = new Time(2007,3,13,23,20,0);
    assertEquals(expected , bean.getLocalTime());
  }
  ...
  public void testGetLocalTimeWest1()
  {
    ...
    bean = new LongitudeTimeBean(lmt , location);
    expected = new Time(2007,3,13,23,54,0);
    assertEquals(expected , bean.getLocalTime());
  }
  ...
  public void testGetLocalTimeWest3()
  {
    ...
    bean = new LongitudeTimeBean(lmt , location);
    expected = new Time(2007,3,14,0,18,0);
    assertEquals(expected , bean.getLocalTime());
  ...
  public void testGetLocalTimeEast()
  {
    ...
    bean = new LongitudeTimeBean(lmt , location);
    expected = new Time(2007,3,14,0,20,0);
    assertEquals(expected , bean.getLocalTime());
  }
  ...
  public void testGetLocalTimeWest()
  {
    ...
    bean = new LongitudeTimeBean(lmt , location);
    expected = new Time(2007,3,13,23,40,0);
    assertEquals(expected , bean.getLocalTime());
  }
