...
class LocationToolsTest {
  ...
  fun testDebugString() {
    LocationTools.run {
      ...
      assertEquals("25.03,121.0 Asia/Taipei 480m", getDebugString(Location(121.0, 25.03, "Asia/Taipei", 480 , null)))
      ...
      assertEquals("40.0,73.0 America/New_York -300m", getDebugString(Location(73.0, 40.0 , "America/New_York" , -300 , null)))
  ...
  fun testDebugStringNew() {
    LocationTools.run {
      ...
      assertEquals(Location(121.0,25.03 , "Asia/Taipei" , 480 , null) , decodeDebugStringNew("25.03,121.0 Asia/Taipei 480m"))
