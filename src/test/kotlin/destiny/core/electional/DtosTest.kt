      ...
      fun single() {
        ...
        val expected = setOf(
          Dtos.EwIdentity.StemCombinedDto(
            "年干(丁) 與 月干(壬) 合木",
            setOf(
              Dtos.EwIdentity.NatalStems(setOf(YEAR), Stem.丁),
              Dtos.EwIdentity.NatalStems(setOf(MONTH), Stem.壬)
            ),
            FiveElement.木
          )
        )
      ...
      fun multiple() {
        ...
        val expected = setOf(
          ...
          Dtos.EwIdentity.StemCombinedDto(
            "日干(癸) 與 時干(戊) 合火",
            setOf(
              Dtos.EwIdentity.NatalStems(setOf(DAY), Stem.癸),
              Dtos.EwIdentity.NatalStems(setOf(HOUR), Stem.戊)
            ),
            FiveElement.火
          )
        )
      ...
      fun multipleCombined1() {
        ...
        val expected = setOf(
          Dtos.EwIdentity.StemCombinedDto(
            ...
            setOf(
              Dtos.EwIdentity.NatalStems(setOf(YEAR), Stem.丁),
              Dtos.EwIdentity.NatalStems(setOf(MONTH, HOUR), Stem.壬)
            ),
            FiveElement.木
          )
        )
      ...
      fun multipleCombined2() {
        ...
        val expected = setOf(
          Dtos.EwIdentity.StemCombinedDto(
            ...
            setOf(
              Dtos.EwIdentity.NatalStems(setOf(YEAR, DAY), Stem.丁),
              Dtos.EwIdentity.NatalStems(setOf(MONTH, HOUR), Stem.壬)
            ),
            FiveElement.木
          )
      ...
      fun isolated() {
        ...
        val expected = setOf(
          Dtos.EwIdentity.BranchCombinedDto(
            "年支(子) 六合 月支(丑)",
            setOf(
              Dtos.EwIdentity.NatalBranches(setOf(YEAR), 子),
              Dtos.EwIdentity.NatalBranches(setOf(MONTH), 丑)
            )
          ),
          Dtos.EwIdentity.BranchCombinedDto(
            "日支(亥) 六合 時支(寅)",
            setOf(
              Dtos.EwIdentity.NatalBranches(setOf(DAY), 亥),
              Dtos.EwIdentity.NatalBranches(setOf(HOUR), 寅)
            )
          )
        )
        assertEquals(expected, dtos)
      ...
      fun merged_1_3() {
        ...
        val expected = setOf(
          Dtos.EwIdentity.BranchCombinedDto(
            ...
            setOf(
              Dtos.EwIdentity.NatalBranches(setOf(YEAR), 子),
              Dtos.EwIdentity.NatalBranches(setOf(MONTH, DAY, HOUR), 丑)
            )
          )
        )
        assertEquals(expected, dtos)
      ...
      fun merged_3_1() {
        ...
        val expected = setOf(
          Dtos.EwIdentity.BranchCombinedDto(
            ...
            setOf(
              Dtos.EwIdentity.NatalBranches(setOf(YEAR, MONTH, HOUR), 子),
              Dtos.EwIdentity.NatalBranches(setOf(DAY), 丑)
            )
          )
        )
        assertEquals(expected, dtos)
      ...
      fun merged_2_2() {
        ...
        val expected = setOf(
          Dtos.EwIdentity.BranchCombinedDto(
            ...
            setOf(
              Dtos.EwIdentity.NatalBranches(setOf(YEAR, MONTH), 子),
              Dtos.EwIdentity.NatalBranches(setOf(DAY, HOUR), 丑)
            )
          )
        )
        assertEquals(expected, dtos)
      ...
      fun single() {
        ...
        val expected = setOf(
          Dtos.EwIdentity.TrilogyDto(
            "年支、月支、日支三合木局",
            setOf(
              Dtos.EwIdentity.NatalBranches(setOf(YEAR), 卯),
              Dtos.EwIdentity.NatalBranches(setOf(MONTH), 未),
              Dtos.EwIdentity.NatalBranches(setOf(DAY), 亥)
            ),
            FiveElement.木
          )
        ...
        val expected = setOf(
          ...
          Dtos.EwIdentity.TrilogyDto(
            ...
            setOf(
              Dtos.EwIdentity.NatalBranches(setOf(MONTH), 未),
              Dtos.EwIdentity.NatalBranches(setOf(DAY), 亥),
              Dtos.EwIdentity.NatalBranches(setOf(HOUR), 卯)
            ),
            FiveElement.木
          )
        )
      ...
      fun isolated() {
        ...
        val expected = setOf(
          Dtos.EwIdentity.BranchOppositionDto(
            "年支(丑) 正沖 日支(未)",
            setOf(
              Dtos.EwIdentity.NatalBranches(setOf(YEAR), 丑),
              Dtos.EwIdentity.NatalBranches(setOf(DAY), 未)
            )
          ),
          Dtos.EwIdentity.BranchOppositionDto(
            "月支(子) 正沖 時支(午)",
            setOf(
              Dtos.EwIdentity.NatalBranches(setOf(MONTH), 子),
              Dtos.EwIdentity.NatalBranches(setOf(HOUR), 午)
            )
          )
        )
        assertEquals(expected, dtos)
      ...
      fun merged1() {
        ...
        val expected = setOf(
          Dtos.EwIdentity.BranchOppositionDto(
            ...
            setOf(
              Dtos.EwIdentity.NatalBranches(setOf(YEAR), 未),
              Dtos.EwIdentity.NatalBranches(setOf(MONTH, DAY, HOUR), 丑)
            )
          )
        )
      ...
      fun merged2() {
        ...
        val expected = setOf(
          Dtos.EwIdentity.BranchOppositionDto(
            ...
            setOf(
              Dtos.EwIdentity.NatalBranches(setOf(YEAR, HOUR), 未),
              Dtos.EwIdentity.NatalBranches(setOf(MONTH, DAY), 丑)
            )
          )
        )
        assertEquals(expected, dtos)
      ...
      fun single() {
        ...
        val expected = setOf(
          Dtos.EwIdentity.StemRootedDto(
            "月干(戊) 通根 年支(辰)、月支(寅)",
            setOf(
              Dtos.EwIdentity.NatalStems(setOf(MONTH), Stem.戊)
            ),
            setOf(
              Dtos.EwIdentity.NatalBranches(setOf(YEAR), 辰),
              Dtos.EwIdentity.NatalBranches(setOf(MONTH), 寅)
            )
          ),
          Dtos.EwIdentity.StemRootedDto(
            "日干(甲) 通根 月支(寅)",
            setOf(
              Dtos.EwIdentity.NatalStems(setOf(DAY), Stem.甲)
            ),
            setOf(
              Dtos.EwIdentity.NatalBranches(setOf(MONTH), 寅)
            )
          ...
          Dtos.EwIdentity.StemRootedDto(
            "時干(癸) 通根 年支(辰)",
            setOf(
              Dtos.EwIdentity.NatalStems(setOf(HOUR), Stem.癸)
            ),
            setOf(
              Dtos.EwIdentity.NatalBranches(setOf(YEAR), 辰)
            )
      ...
      fun multiple_stemMerged() {
        ...
        val expected = setOf(
          Dtos.EwIdentity.StemRootedDto(
            "年干、時干(均為 丁) 通根 日支(未)",
            setOf(
              Dtos.EwIdentity.NatalStems(setOf(YEAR, HOUR), Stem.丁)
            ),
            setOf(
              Dtos.EwIdentity.NatalBranches(setOf(DAY), 未)
            )
